                ...
                <div class="row ">
                    <div class="col-lg-4">
                        <div class="cyber-single-service bg-white rounded-custom mb-30">
                            <div class="feature-icon pb-5 rounded bg-primary-soft dark-red mb-4">
                    ...
                    <div class="col-lg-6 mt-4">
                        <div class="position-relative d-flex flex-column h-100 flex-wrap bg-primary-soft p-5 rounded-custom">
                            <div class="cta-left-info mb-2">
                                <h5>Nomination:</h5>
                                <p1><span class="text-black">After the application is submitted and assessed by the province, successful candidates are nominated for permanent residence in Canada. This<span class="dark-red"> nomination adds additional points to the candidate's Express Entry CRS score</span>, significantly increasing their chances of receiving an ITA in the federal Express Entry draws.</span> </p1>
                            </div>
  ...
  <path d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-1-5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM4 8a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0 2.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z"/>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="emailMarketing" role="tabpanel">
                                <div class="border border-red-clr rounded-4 padding-4">
                                    <div class="social-media-conten bgc-white rounded-4 section-space padding-x-2 padding-x-xsm-4 padding-x-sm-8 padding-x-md-12 padding-end-xxl-25">
                                        <div class="row">
                                            <div class="col-lg-5 col-xl-6 col-xxl-7 ms-lg-auto">
                                                <h5 class="heading-5 font-weight-semibold margin-bottom-5 clr-text">
                                                    Family Sponsorship
                                                ...
                                                <ul class="list gap-3">
                                                    ...
                                                    <li>
                                                        <div class="d-flex gap-2 align-items-center clr-paragraph">
                                                            ...
                                                            <p class="mb-0 flex-grow-1 text-black dark-red">
