                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
                            <h4 class="text-danger   h5 mb-2">  Immigration Services in the USA and Canada</h4>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5">
                        <div class="section-title text-center mb-5">
                          <h4>  <span class=" text-danger   ">IMMIGRATION SERVICES</h4></span>
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="dg-service-item bg-white rounded">
                            ...
                            <a href="service-single.html">
                                <h5 class="mt-4 mb-2 heading-dg-color text-danger">Visit Canada</h5>
                            </a>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="dg-service-item bg-white rounded">
                            ...
                            <a href="service-single.html">
                                <h5 class="mt-4 mb-2 heading-dg-color text-danger">Study In <br>Canada</h5>
                            </a>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="dg-service-item bg-white rounded">
                            ...
                            <a href="service-single.html">
                                <h5 class="mt-4 mb-2 heading-dg-color text-danger">Work In Canada</h5>
                            </a>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="dg-service-item bg-white rounded">
                            ...
                            <a href="service-single.html">
                                <h5 class="mt-4 mb-2 heading-dg-color text-danger">International Experience on Canada(IEC)</h5>
                            </a>
                ...
                <div class="row align-items-center g-4">
                    <div class="col-xl-5 col-lg-6">
                        <div class="dg-team-content text-center text-lg-start mb-4 mb-lg-0">
                            ...
                            <p class="mb-40 text-black"><b>Our exceptional immigration services have garnered not only trust but also admiration from our clients. Their experiences stand as a testament to our commitment in providing reliable and efficient assistance throughout their immigration journey.</b></p>
                ...
                <div class="row justify-content-lg-between align-items-center">
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="why-choose-content">
                            ...
                            <h5 class="text-danger">Benefits of Choosing Our Company</h5>
                            ...
                            <ul class="list-unstyled d-flex flex-wrap list-two-col mt-4 mb-4">
                                <li class="py-1 text-black"><i class="fas fa-check-circle me-2 text-danger"></i>Expertise and Experience</li>
                                <li class="py-1 text-black"><i class="fas fa-check-circle me-2 text-danger"></i>Legal Insight and Compliance</li>
                                <li class="py-1 text-black"><i class="fas fa-check-circle me-2 text-danger"></i>Time and Stress Savings</li>
                                <li class="py-1 text-black"><i class="fas fa-check-circle me-2 text-danger"></i>Enhanced Chances of Success</li>
                                <li class="py-1 text-black"><i class="fas fa-check-circle me-2 text-danger"></i>Legal Insight and Compliance</li>
                                <li class="py-1 text-black"><i class="fas fa-check-circle me-2 text-danger"></i>Customer-Centric Focus</li>
                            </ul>
                ...
                <div class="row justify-content-center justify-content-xxl-start pb-80 pt-50">
                    <div class="col-xxl-6 col-lg-7">
                        <div class="section-title text-center text-xxl-start">
                            <h6 class="mb-0 text-danger">How to Apply</h6>
                ...
                <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="htw-single-item bg-white rounded">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="mb-0 ms-3 text-danger">Express Entry</h5>
                            </div>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="htw-single-item bg-white rounded">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="mb-0 ms-3 text-danger">Provincial Nominee Program</h5>
                            </div>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="htw-single-item bg-white rounded">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="mb-0 ms-3 text-danger">Family Sponsorship</h5>
                            </div>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="htw-single-item bg-white rounded">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="mb-0 ms-3 text-danger">Permanent Residence Cards</h5>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-10">
                        <div class="faq-content-wrap d-flex mb-5 aos-init aos-animate" data-aos="fade-up" data-aos-delay="50">
                            ...
                            <div class="faq-info">
                                <h5>What services do you offer for immigration to Canada and the USA?</h5>
                                <p class="mb-0 text-black">Our immigration services encompass a wide range of offerings, including visa consultation, document preparation, application submission, interview preparation, legal guidance, and ongoing support. We tailor our services to your specific immigration goals, ensuring a seamless and informed process.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-10">
                        <div class="faq-content-wrap d-flex mb-5 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="faq-info">
                                <h5>How can your services benefit me during the immigration process?</h5>
                                <p class="mb-0 text-black">Our experienced team is well-versed in the intricacies of immigration regulations for both Canada and the USA. We provide personalized assistance, ensuring that your applications are meticulously prepared, deadlines are met, and you are well-prepared for interviews and examinations. Our goal is to maximize your chances of a successful immigration outcome.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-10">
                        <div class="faq-content-wrap d-flex mb-5 aos-init aos-animate" data-aos="fade-up" data-aos-delay="150">
                            ...
                            <div class="faq-info">
                                <h5>How do you stay updated on changing immigration laws and policies?</h5>
                                <p class="mb-0 text-black">Staying current with evolving immigration laws and policies is our priority. Our team actively monitors updates from relevant government agencies in both Canada and the USA. This ensures that the guidance and support we offer are aligned with the latest legal requirements, optimizing your immigration journey.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-10">
                        <div class="faq-content-wrap d-flex mb-5 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="faq-info">
                                <h5> Can I initiate the immigration process on my own without professional assistance?</h5>
                                <p class="mb-0 text-black">Certainly, you can initiate the process independently. However, partnering with our immigration experts can provide invaluable advantages. We offer insights, reduce the likelihood of errors, streamline the process, and provide peace of mind throughout your journey, helping you achieve your immigration goals more efficiently.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-10">
                        <div class="faq-content-wrap d-flex mb-5 aos-init aos-animate" data-aos="fade-up" data-aos-delay="250">
                            ...
                            <div class="faq-info">
                                <h5>How do I get started with your immigration services?
</h5>
                                <p class="mb-0 text-black">To get started, simply reach out to our team through our website or contact information. We'll schedule an initial consultation where we'll discuss your immigration aspirations, assess your eligibility, and outline the best pathway for you. From there, we'll guide you through the necessary steps to begin your immigration process with confidence.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-10">
                        <div class="faq-content-wrap d-flex mb-5 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div class="faq-info">
                                <h5>What sets your immigration services apart from others?</h5>
                                <p class="mb-0 text-black">Our immigration services stand out due to our personalized approach, years of experience, and proven track record of successful client outcomes. We prioritize your needs and provide unwavering support, ensuring you are well-informed and empowered throughout your journey to Canada or the USA.</p>
                            </div>
                        </div>
                    </div>
                </div>
