                    ...
                    <div class="row">
                        <div class="col-12">
                            <ul class="nav justify-content-center feature-tab-list-2 mt-4" id="nav-tab-2" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="#tab-2-4" data-bs-toggle="tab" data-bs-target="#tab-2-4" role="tab" aria-selected="false" tabindex="-1">
                                       staffing
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="#tab-2-5" data-bs-toggle="tab" data-bs-target="#tab-2-5" role="tab" aria-selected="false" tabindex="-1">
                                        Product Developmemt
                                    </a>
                                </li>
                            </ul>
                            <div class="tab-content" id="nav-tabContent-2">
                                    ...
                                    <div class="row justify-content-center align-items-center justify-content-around">
                                        <div class="col-lg-5">
                                            <div class="feature-tab-info">
                                                <h3>IOT</h3>
                                                <p> In today's interconnected world, the Internet of Things (IoT) has emerged as a game-changer, revolutionizing industries and transforming the way we live and work. 
                                ...
                                <div class="tab-pane fade pt-60" id="tab-2-2" role="tabpanel">
                                    <div class="row justify-content-center align-items-center justify-content-around">
                                        <div class="col-lg-5">
                                            <img src="assets/img/smnew.jpg" alt="feature tab" class="img-fluid mb-4 mb-lg-0 mb-xl-0">
                                        </div>
                                        <div class="col-lg-5">
                                            <div class="feature-tab-info">
                                            ...
                                            <p>Contact us today to discuss your Android app development requirements and let us help you unleash the power of the world's most popular mobile platform.</p>
                                                <a href="{{ route('mobileapp')}}" class="read-more-link text-decoration-none mt-4 d-block">Know More About Us
                                                    <i class="fas fa-arrow-right ms-2"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade pt-60" id="tab-2-3" role="tabpanel">
                                   ...
                                   <p> Our team of experienced web developers combines creativity with technical expertise to create visually stunning and functional websites. From e-commerce platforms that drive online sales to dynamic web applications that streamline business processes, we tailor our solutions to meet your specific goals. With a focus on responsive design, smooth user experiences, and powerful functionality, we deliver web solutions that leave a lasting impression.</p>
                                                <a href="{{ route('webapp')}}" class="read-more-link text-decoration-none mt-4 d-block">Know More About Us
                                                    <i class="fas fa-arrow-right ms-2"></i></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-5">
                                            <img src="assets/img/3in11.jpg" alt="feature tab" class="img-fluid mt-4 mt-lg-0 mt-xl-0">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row justify-content-center align-items-center justify-content-around">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="feature-tab-info">
                                                ...
                                                <a href="{{ route('staffing')}}" class="read-more-link text-decoration-none mt-4 d-block">Know More About Us
                                                    <i class="fas fa-arrow-right ms-2"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade pt-60" id="tab-2-5" role="tabpanel">
                                    <div class="row justify-content-center align-items-center justify-content-around">
                                        ...
                                        <p>Contact us today to discuss your prototype development needs and bring your ideas to life.</p>
                                                <a href="{{ route('product')}}" class="read-more-link text-decoration-none mt-4 d-block">Know More About Us
                                                    <i class="fas fa-arrow-right ms-2"></i></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-5">
                                            <img src="assets/img/productdev1.jpg" alt="feature tab" class="img-fluid mt-4 mt-lg-0 mt-xl-0">
                                        </div>
                                    </div>
                                </div>
                            </div>
